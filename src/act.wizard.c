/**************************************************************************
*  File: act.wizard.c                                      Part of altMUD *
...
static struct set_struct {
   ...
   { "hitpoints",       LVL_BUILDER, 	BOTH, 	NUMBER }, /* 18 */
  ...
  switch (mode) {
   ...
   case 21: /* int */
    ...
    case 30: /* maxmove */
      ...
      break;
    case 31: /* maxstun */
      vict->points.max_stun = RANGE(1, 5000);
      affect_total(vict);
      break;
    case 32: /* move */
    ...
    case 50: /* stradd */
      ...
      break;
    case 51: /* stun */
      vict->points.stun = RANGE(0, vict->points.max_stun);
      affect_total(vict);
      break;
    case 52: /* thief */
